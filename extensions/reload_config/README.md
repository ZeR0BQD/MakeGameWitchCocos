...
After enabling the extension, click `Panel -> reload_config -> Default Panel` in the main menu bar to open the default panel of the extension.

To send a message to the default panel, click `Developer -> reload_config -> Send Message to Panel` at the top of the menu. If the default panel
